...
export const VLAN_CONFIG: Record<number, VlanConfig> = {
  ...
  6: { name: "EMPLOYER ISOLATED", code: "SECTOR-06", color: "#6B7785", subnet: "172.20.6.0/24" },
...
export const NODE_TYPES: Record<string, NodeTypeConfig> = {
  router: { icon: "router", color: "#2FA4FF", label: "Router/Firewall" },
  switch: { icon: "switch", color: "#00E5FF", label: "Core Switch" },
  proxmox: { icon: "proxmox", color: "#7A5CFF", label: "Proxmox Node" },
  storage: { icon: "storage", color: "#21D07A", label: "Storage" },
  "docker-host": { icon: "docker", color: "#7A5CFF", label: "Docker Host" },
  security: { icon: "security", color: "#FF4D4F", label: "Security/IAM" },
  media: { icon: "media", color: "#FF4FD8", label: "Media Server" },
  network: { icon: "network", color: "#00E5FF", label: "Network Device" },
  iot: { icon: "iot", color: "#6B7785", label: "IoT Device" },
  workstation: { icon: "workstation", color: "#E6EDF3", label: "Workstation" },
  vm: { icon: "vm", color: "#2FA4FF", label: "Virtual Machine" },
  lxc: { icon: "lxc", color: "#00E5FF", label: "LXC Container" },
  container: { icon: "container", color: "#7A5CFF", label: "Docker Container" },
  mail: { icon: "mail", color: "#00E5FF", label: "Mail Server" },
  monitor: { icon: "monitor", color: "#FFC857", label: "Monitoring" },
  vpn: { icon: "vpn", color: "#21D07A", label: "VPN" },
  dns: { icon: "dns", color: "#00E5FF", label: "DNS" },
  agent: { icon: "agent", color: "#32FF9C", label: "AI Agent" },
};
...
export const CONNECTION_STYLES: Record<string, ConnectionStyle> = {
  backbone: { color: "#2FA4FF", width: 3.5, dash: null, label: "10 Gbps" },
  "5g": { color: "#FF4FD8", width: 2.5, dash: null, label: "5 Gbps" },
  "2.5g": { color: "#00E5FF", width: 2, dash: null, label: "2.5 Gbps" },
  network: { color: "#00E5FF", width: 1.2, dash: null, label: "1 Gbps" },
  hypervisor: { color: "#7A5CFF", width: 1.5, dash: "4,4", label: "Hypervisor" },
  service: { color: "#21D07A", width: 1, dash: "6,3", label: "Service" },
  auth: { color: "#FF4D4F", width: 1, dash: "2,4", label: "Auth" },
  dns: { color: "#FFC857", width: 1, dash: "8,4", label: "DNS" },
  storage: { color: "#21D07A", width: 2, dash: null, label: "Storage" },
};
